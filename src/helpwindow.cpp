      ...
      path(QFileInfo(home_).path(), "*.htm*")
{
    ...
    forwardAction = go->addAction(QPixmap(forward_icon), "&Forward", browser, SLOT(forward()), Qt::ALT | Qt::Key_Right);
    ...
    QAction *fButton;
    fButton = new QAction(QPixmap(forward_icon), "Forward", browser);
